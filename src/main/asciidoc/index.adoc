= Ascii doctor will take little pices of code snippets and them assembles them to single html document
=  Ascii doctor will be assemble ( gromadzić ) things into single document and then uses it to produce Html document
=  Ascii Docs looks at this index.adoc and generates generated-docs/index.html for us
Order Service Docs
John Thompson;
:doctype: book
:icons: font
